declare module 'frappe-charts' {
    ...
    export type AxisChartDataPoint = {
        index: number;
        label: string;
        values: number[];
    }
    ...
    /** Pie Chart Data Point or Axis Chart Data Point */
    export type ChartDataPoint = PieChartDataPoint | AxisChartDataPoint;
    ...
    export type ChartType = 'line' | 'bar' | 'donut' | 'pie' | 'percentage' | 'heatmap';
